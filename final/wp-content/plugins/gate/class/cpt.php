<?php
	...
	class gateManageCPT{
			...
			*/
			if(class_exists('acf')){
				add_action('acf/init', function(){
					...
					// Add option in CPT Management
					$this->acf();

					// Add CPT created from CPT Management
					$this->add();
				});
			}
		...
		function manager(){
			...
			register_post_type("gate_cpt", $args);
		}
			...
			if($cpt->have_posts()){
				while($cpt->have_posts()) : $cpt->the_post();
					...
					if(gc::field('labels')){
						...
						*/
						$labels = array_filter(gc::field('labels'));
						$args = gc::field('args');
						unset($args['']);
						...
						*/
						...
						$this->register_tax($post_type, get_the_ID());
					}
		...
		function register_tax($post_type_slug, $post_type_id){

			if(gc::field('taxonomies', $post_type_id)){
				foreach(gc::field('taxonomies', $post_type_id) as $tax){
					/*
					* Get Labels and arguments without empties
					*/
					...
					*/
					register_taxonomy($callback, array($post_type_slug), $args);
				}
			}
		}
