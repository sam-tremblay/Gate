...
)) {!function(e){var t=Object.prototype.hasOwnProperty.call(Object.prototype,"__defineGetter__"),r="A property cannot both have accessors and be writable or have a value";Object.defineProperty=function n(o,i,f){if(e&&(o===window||o===document||o===Element.prototype||o instanceof Element))return e(o,i,f);if(null===o||!(o instanceof Object||"object"==typeof o))throw new TypeError("Object.defineProperty called on non-object");if(!(f instanceof Object))throw new TypeError("Property description must be an object");var c=String(i),a="value"in f||"writable"in f,p="get"in f&&typeof f.get,s="set"in f&&typeof f.set;if(p){if(p===undefined)return o;if("function"!==p)throw new TypeError("Getter must be a function");if(!t)throw new TypeError("Getters & setters cannot be defined on this javascript engine");if(a)throw new TypeError(r);Object.__defineGetter__.call(o,c,f.get)}else o[c]=f.value;if(s){if(s===undefined)return o;if("function"!==s)throw new TypeError("Setter must be a function");if(!t)throw new TypeError("Getters & setters cannot be defined on this javascript engine");if(a)throw new TypeError(r);Object.__defineSetter__.call(o,c,f.set)}return"value"in f&&(o[c]=f.value),o}}(Object.defineProperty);}function CreateMethodProperty(e,r,t){var a={value:t,writable:!0,enumerable:!1,configurable:!0};Object.defineProperty(e,r,a)}if (!("forEach"in Array.prototype
...
var gscroll;function wpGate(){window.scrollTo(0,0),"scrollRestoration"in history&&(history.scrollRestoration="manual");var t=!!window.MSInputMethodContext&&!!document.documentMode,o=/Edge/.test(navigator.userAgent);(t||o)&&setTimeout(function(){window.scrollTo(0,0)},300),$.fn.gatePageTransition=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},o=$(this),n={};$.each(t,function(t,o){n[t]=o}),n.onPageStart&&n.onPageStart(),n.onPageLeave&&o.on("click",function(t){t.preventDefault();t=$(this).attr("href")?$(this).attr("href"):$(this).attr("data-href");$(this).hasClass("redirect")||"_blank"===$(this).attr("target")?window.open(t,"_blank"):n.onPageLeave(t)})},$.fn.gateScroll=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},o=$(this)[0].id.length?"#"+$(this)[0].id:"."+$(this)[0].className,n={el:document.querySelector(o),smooth:!0};$(o).attr("data-scroll-container",""),$.each(t,function(t,o){n[t]=o}),gscroll=new LocomotiveScroll(n),n.onScroll&&gscroll.on("scroll",function(t){n.onScroll(t)}),$(window).on("load",function(){gscroll.update()})}}wpGate();